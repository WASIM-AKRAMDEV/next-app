...
const Footer = () => {
  ...
  return (
    <div className={`bg-[#f1f4f5] mt-40 ${darkMode ? 'dark:bg-[#04080a]' : ''}`}>
      <div className="mx-auto px-5  sm:px-4 lg:px-4 lg:max-w-[1530px] py-[40px]">
        <div className="flex items-center gap-7 ">
          <Link href="#" className={`text-black text-16px font-[600] ${darkMode ? 'dark:text-white' : ''} `}>
            Follow Us
          </Link>
          <Link href="#">
        ...
        <div className="my-8 border-y border-[#e5e7e9] py-8 flex lg:flex-nowrap flex-wrap lg:gap-0 gap-12 ">
          <div className={` text-black max-w-[290px] w-full ${darkMode ? 'dark:text-white' : ''}`}>
            <h6 className="font-[600] mb-8 text-[16px]">Internal Links</h6>
            <ul className={`text-[#1d2938] flex flex-col gap-5 ${darkMode ? 'dark:text-white' : ''} `}>
              <li>
        ...
        <div className=" flex justify-between items-center relative">
          <div className="flex lg:flex-row flex-col lg:items-center items-start  lg:gap-0 gap-5  ">
            <h1 className={`text-[#1d2938] font-[700] text-[30px]  ${darkMode ? 'dark:text-white' : ''}`}>
              Similar
              <span className="text-[#f1f4f5] text-[20px] rounded-xl bg-[#1d2938] p-2 ms-1 ">
                Watch
              </span>
            </h1>
            <ul className={`flex gap-5 ms-6 text-[#1d2938] md:flex-nowrap flex-wrap ${darkMode ? 'dark:text-white' : ''}`}>
              <li>
          ...
          <a
  href="#"
  className="w-[45px] h-[45px] bg-[#dedede] rounded-full flex justify-center items-center absolute right-0 top-[6px] md:top-[none] "
  onClick={() => (darkMode ? toggleLightMode() : toggleDarkMode())}
>
  {darkMode ? (
