...
const SwiperCards = () => {
  ...
  return (
    <div className=" mx-auto px-5  sm:px-4 lg:px-6 lg:max-w-[1400px] py-[40px]">
      <h1 className="text-black lg:text-[30px] md:text-[30px]  sm:text-[30px] text-[16px] font-[700] py-2">
        Convert from PDF
      </h1>
          ...
          {SwiperItems.map((item, index) => (
            <SwiperSlide key={index} className="py-4">
              <Card key={index} className=" w-full hover:shadow-xl relative group">
                ...
                <h2 className="font-[700] lg-text-[20px] md:text-[20px] sm:text-[14px] text-[14px] mt-5 mb-3">
                  {item.title}
                </h2>
