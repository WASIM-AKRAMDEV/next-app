...
const ConvertOne = () => {
  ...
  return (
    <div className="mx-auto px-5  sm:px-4 lg:px-4 lg:max-w-[1400px] py-[40px]">
      <h1 className="text-black  dark:text-white lg:text-[30px] md:text-[30px]  sm:text-[30px] text-[16px] font-[700] py-6">
        Covert from PDF
      </h1>
            {/* Card Section */}
       ...
       {convertItems.map((item, index) => (
          <Card key={index} className="sm:w-full md:w-1/2 lg:w-1/2 xl:w-1/4 hover:shadow-xl lg:max-w-[258px] md:max-w-[350px]  w-full">
            ...
            <h2 className="text-black  dark:text-white font-[700] lg-text-[20px] md:text-[20px] sm:text-[14px] text-[14px] mt-5 mb-3">{item.title}</h2>
